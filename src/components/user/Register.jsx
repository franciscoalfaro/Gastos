...
import userImage from '../../assets/img/curved-images/curved14.jpg'
  ...
  return (
    <>
      <section className="min-vh-100 mb-8">
        <div className="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style={divStyle}>
                ...
                <div className="card-body">
                  <form role="form text-left" onSubmit={saveUser}>
                    <div className="mb-3">
                      ...
                      <input type="text" className="form-control" name="name" placeholder="Nombre" aria-label="Name" aria-describedby="name-addon" onChange={changed}></input>
                    </div>
                    <div className="mb-3">
                      <label htmlFor='surname'>Apellido</label>
                      <input type="text" className="form-control" name="surname" placeholder="Apellido" aria-label="Apellido" aria-describedby="name-addon" onChange={changed}></input>
                    </div>
                    <div className="mb-3">
                      <label htmlFor='nick'>Nick</label>
                      <input type="text" className="form-control" name="nick" placeholder="Nick" aria-label="Nick" aria-describedby="name-addon" onChange={changed}></input>
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                      ...
                      <input type="password" className="form-control" name="password" placeholder="Password" aria-label="Password" aria-describedby="password-addon" onChange={changed}></input>
                    </div>
